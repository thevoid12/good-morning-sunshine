...
const (
	SCHEMA       = "CREATE TABLE IF NOT EXISTS email_record (id TEXT NOT NULL,email_id TEXT NOT NULL,owner_mail TEXT NOT NULL,expiry_date TEXT NOT NULL,created_on TIME NOT NULL,is_deleted BOOL NOT NULL);"
	...
	//QUERY
	CREATE_EMAIL_RECORD_QUERY         = "INSERT OR REPLACE INTO email_record(id,email_id,owner_mail,expiry_date,created_on,is_deleted) VALUES(?,?,?,?,?,?);"
